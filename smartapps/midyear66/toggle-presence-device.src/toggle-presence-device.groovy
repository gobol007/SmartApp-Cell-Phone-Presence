...
def snd_sms(){
    ...
    sendSms(phone, "${light.name} - https://graph-na04-useast2.api.smartthings.com/api/token/${state.accessToken}/smartapps/installations/${app.id}/iPhone/here")
    sendSms(phone, "${light.name} - https://graph-na04-useast2.api.smartthings.com/api/token/${state.accessToken}/smartapps/installations/${app.id}/iPhone/away")
    DEBUG("${phone} - ${light.name} - https://graph-na04-useast2.api.smartthings.com/api/token/${state.accessToken}/smartapps/installations/${app.id}/iPhone/here")
	DEBUG("${phone} - ${light.name} - https://graph-na04-useast2.api.smartthings.com/api/token/${state.accessToken}/smartapps/installations/${app.id}/iPhone/away")
